...
teacher_model = get_resnet_18_pytorchmodel('./pretrained/resnet_18_mini_imagenet_pytorchmodel/model.pth')
...
torch.save(student_model.state_dict(),
           './pretrained/resnet18_knowledge_distilltion_googlenet_pytorchmodel_mini_imagenet/model.pth')
test(student_model)
