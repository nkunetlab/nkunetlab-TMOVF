...
batch_size_test = 100
learning_rate = 1e-4
train_loader, test_loader = get_mini_imagenet(batch_size_train=batch_size_train, batch_size_test=batch_size_test)
teacher_model = get_resnet_50_pytorchmodel('./pretrained/resnet_50_mini_imagenet_pytorchmodel/model.pth')
student_model = models.googlenet(pretrained=True)
student_model.fc = nn.Linear(in_features=1024, out_features=100, bias=True)
...
torch.save(student_model.state_dict(),
           './pretrained/resnet50_knowledge_distilltion_googlenet_pytorchmodel_mini_imagenet/model.pth')
test(student_model)
