...
teacher_model = get_resnet_18_pytorchmodel('./pretrained/resnet_18_cifar10_pytorchmodel/model.pth')
...
torch.save(student_model.state_dict(), './pretrained/resnet18_knowledge_distilltion_googlenet_pytorchmodel/model.pth')
test(student_model)