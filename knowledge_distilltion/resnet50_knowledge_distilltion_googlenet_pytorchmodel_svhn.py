...
teacher_model = get_resnet_50_pytorchmodel('./pretrained/resnet_50_svhn_pytorchmodel/model.pth')
...
torch.save(student_model.state_dict(), './pretrained/resnet50_knowledge_distilltion_googlenet_pytorchmodel_svhn/model.pth')
test(student_model)