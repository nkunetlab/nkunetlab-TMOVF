...
teacher_model = get_resnet_18_pytorchmodel('./pretrained/resnet_18_cifar100_pytorchmodel/model.pth')
...
torch.save(student_model.state_dict(), './pretrained/resnet18_knowledge_distilltion_googlent_pytorchmodel_cifar100/model.pth')
test(student_model)