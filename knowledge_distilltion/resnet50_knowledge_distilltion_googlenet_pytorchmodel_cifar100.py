...
teacher_model = get_resnet_50_pytorchmodel('./pretrained/resnet_50_cifar100_pytorchmodel/model.pth')
...
torch.save(student_model.state_dict(), './pretrained/resnet50_knowledge_distilltion_googlenet_pytorchmodel_cifar100/model.pth')
test(student_model)