...
batch_size_test = 100
learning_rate = 1e-4
train_loader, test_loader = getCifar10(batch_size_train=batch_size_train, batch_size_test=batch_size_test)
teacher_model = get_resnet_50_pytorchmodel('./pretrained/resnet_50_cifar10_pytorchmodel/model.pth')
...
torch.save(student_model.state_dict(), './pretrained/resnet50_knowledge_distilltion_googlenet_pytorchmodel_cifar10/model.pth')
test(student_model)