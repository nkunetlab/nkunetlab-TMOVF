...
import torch
from dataset.cifar10 import get_cifar10_small_trainset
from dataset.cifar100 import get_cifar100_small_trainset
from dataset.svhn import get_svhn_small_trainset
from dataset.mini_imagenet import get_mini_imagenet_small_trainset
import numpy as np
import random
...
cifar10_small_trainset=get_cifar10_small_trainset()
cifar100_small_trainset=get_cifar100_small_trainset()
mini_imagenet_small_trainset=get_mini_imagenet_small_trainset()
svhn_small_trainset=get_svhn_small_trainset()
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./ECOD_trainset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)




# cifar10+resnet18
testloader = cifar10_small_trainset
...
# svhn+resnet18
testloader = svhn_small_trainset
y_train_scores_1 = get_train_scores(
...
# cifar100+resnet18
testloader = cifar100_small_trainset
y_train_scores_1 = get_train_scores(
...
testloader=mini_imagenet_small_trainset
y_train_scores_1 = get_train_scores(
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./COPOD_trainset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./ROD_trainset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./CBLOF_trainset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)
'''
# cifar10+resnet18
testloader=cifar10_small_trainset
y_train_scores_1 = get_train_scores(
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./COF_trainset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)
