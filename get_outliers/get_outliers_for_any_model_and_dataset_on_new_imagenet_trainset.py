...
import torch
from dataset.new_imagenet import get_new_imagenet_small_testset, get_new_imagenet_small_trainset
import numpy as np
import random
...
testloader = get_new_imagenet_small_trainset()
'''
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./new_imagenet_results/ECOD_testset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)



# new_imagenet+resnet18
...
tocsv(y_train_scores_1, 1, './results/new_imagenet/resnet18')
y_train_scores_2 = get_train_scores(
    get_resnet_18_pytorchmodel('./pretrained/resnet_18_mini_imagenet_pruned_0.1_unretrained_pytorchmodel/model.pth',
                               100))
tocsv(y_train_scores_2, 2, './results/new_imagenet/resnet18')
y_train_scores_3 = get_train_scores(
    get_resnet_18_pytorchmodel('./pretrained/resnet_18_mini_imagenet_pruned_0.3_unretrained_pytorchmodel/model.pth',
                               100))
tocsv(y_train_scores_3, 3, './results/new_imagenet/resnet18')
y_train_scores_4 = get_train_scores(
    get_resnet_18_pytorchmodel('./pretrained/resnet_18_mini_imagenet_pruned_0.5_unretrained_pytorchmodel/model.pth',
                               100))
tocsv(y_train_scores_4, 4, './results/new_imagenet/resnet18')
...
tocsv(y_train_scores_5, 5, './results/new_imagenet/resnet18')
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./new_imagenet_results/COPOD_testset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./new_imagenet_results/CBLOF_testset' + prefix[1:] + f'/list{i}.csv', mode="a", encoding="utf_8_sig", header=1, index=0)
...
def tocsv(name, i, prefix):
    list0 = name.tolist()
    df = pd.DataFrame(data=list0)
    df.to_csv('./sentegraphy_imagenet_COF_trainset_again' + prefix[1:] + f'/list{i}.csv', mode="a",
              encoding="utf_8_sig", header=1, index=0)
