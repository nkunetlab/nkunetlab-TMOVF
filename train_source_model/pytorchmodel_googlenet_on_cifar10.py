...
'''
network.fc = nn.Linear(in_features=1024, out_features=10, bias=True)
network = network.to(device)
optimizer = optim.SGD(network.parameters(), lr=learning_rate, momentum=momentum)


def train(epoch, network=network,
          model_save_dir='./pretrained/googlenet_imagenet_finetune_cifar10_pytorchmodel_unfrozen/model.pth',
