...
set_seed()
trainloader, testloader = get_mini_imagenet(batch_size_train=64, batch_size_test=100)
...
for i in range(100):
    train(i)
    torch.save(network.state_dict(), './pretrained/resnet_18_mini_imagenet_pytorchmodel/model.pth')
    test()
