...
'''
注意把models.resnet50()的fc层的输出改为10
'''
...
set_seed()
trainloader, testloader = getCifar10(batch_size_train=64, batch_size_test=100)
...
for i in range(100):
    train(i)
    torch.save(network.state_dict(), './pretrained/resnet_50_cifar10_pytorchmodel/model.pth')
    test()
