...
model = get_resnet_50_pytorchmodel('./pretrained/resnet_50_mini_imagenet_pytorchmodel/model.pth')
model.fc = nn.Linear(in_features=2048, out_features=100, bias=True)
model = model.to(device)
...
torch.save(model.state_dict(), './pretrained/resnet_50_mini_imagenet_finetune_mini_imagenet_unfrozen_pytorchmodel/model.pth')
